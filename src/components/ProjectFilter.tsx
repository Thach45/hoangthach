    ...
    <div className="mb-8 space-y-4">
      ...
      <div className="relative w-full max-w-2xl mx-auto">
        <input
          ...
          className="w-full px-6 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-sm"
        />
        <button
